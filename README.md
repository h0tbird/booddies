...
Boot buddies or `booddies` is a set of [`Docker`][docker-web] containers used to bootstrapp a [`Mesos`][mesos-web] cluster with Docker containers on top of [`CoreOS`][coreos-web] on top of [`KVM`][kvm-web] on top of bare metal.
